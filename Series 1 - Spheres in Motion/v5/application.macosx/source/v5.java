...
public void draw() {
  ...
  sink2X = width/2 - width/2 * cos(time*0.01f);
  sink2Y = width/2 - height/2 * sin(time*0.01f);
...
public void shiftBlur(final int[] s, final int[] t, final int a, final int b, final int c){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#666666", "--stop-color=#cccccc", "v5" };
    if (passedArgs != null) {
